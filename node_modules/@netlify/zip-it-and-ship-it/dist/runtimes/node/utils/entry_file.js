...
export const kebabCase = (input) => input
    ...
    .split(' ')
    .join('-');
const getEntryFileContents = (mainPath, moduleFormat, runtimeAPIVersion, addBootstrap) => {
...
export const getEntryFile = ({ addBootstrap, commonPrefix, featureFlags, filename, mainFile, moduleFormat, userNamespace, runtimeAPIVersion, }) => {
